...
namespace Alkemy_backend.Controllers
{
    ...
    public class DocenteController : ControllerBase
    {
        ...
        public DocenteController(AlkemyContext context)
        {
            _context = context;
        }
        ...
        // GET: api/Docentes/33222000
        [HttpGet("{dni}")]
        public async Task<ActionResult<Docente>> GetDocentebydni(int dni)
        {
            var docente = await _context.Docente.FirstOrDefaultAsync(a => a.Dni == dni);
